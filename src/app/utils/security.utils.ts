...
export class Security {
    ...
    public static setTokenTemporaly(token: string) {
        localStorage.setItem('_tt', token)
    }
    ...
    public static clear() {
        ...
        localStorage.removeItem('_ci') //customerId
        localStorage.removeItem('_un') //username
        localStorage.removeItem('_boi') //branchOfficeId
        localStorage.removeItem('_tt') // temporalityToken
    }
}
